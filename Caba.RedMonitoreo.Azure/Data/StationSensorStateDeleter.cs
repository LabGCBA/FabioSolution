...
{
	public class StationSensorStateDeleter: IStationSensorStateDeleter
	{
        private readonly CloudStorageAccount account;
		public StationSensorStateDeleter(CloudStorageAccount account)
		{
        ...
        private static DynamicTableEntity GetTableEntity(string partition, string rowKey, DateTimeOffset at, double state)
        {
            ...
            var tableEntity = new DynamicTableEntity(partition, rowKey)
            {
                Properties = new Dictionary<string, EntityProperty>
                {
                    ...
                    [nameof(SensorState.Active)] = new EntityProperty(false),
                }
            };
            return tableEntity;
        }

        public async Task Delete(string stationId, string sensorId, string partition, string rowkey)
		{
